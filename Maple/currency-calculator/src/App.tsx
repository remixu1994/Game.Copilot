...
function App() {
  ...
  return <main className="simulator-shell">
    <header className="topbar"><a className="brand-mark" href="/" style={{ color: 'inherit', textDecoration: 'none' }}>Maple<span>Lab</span></a><div className="topbar-title"><span className="red-dot" />伤害 DPS 模拟器</div><a className="ghost-button" href="/upgrade" style={{ textDecoration: 'none' }}>装备升级</a></header>
