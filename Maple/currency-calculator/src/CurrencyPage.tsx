...
function EventShopPage() {
  ...
  return <main className="currency-shell">
    <header className="currency-header"><div><a className="currency-brand" href="/">Maple<span>Lab</span></a><span className="currency-divider">/</span><span>活动币商店</span></div><a href="/dps">伤害 DPS 模拟器</a></header>
